// HeapSortConsole.cpp : 此檔案包含 'main' 函式。程式會於該處開始執行及結束執行。
//
...
int main()
{
	...
	std::mt19937 rng(dev());
	std::uniform_int_distribution<std::mt19937::result_type> dist6(0, 508);
	...
	do {
		...
		for (int r = 0; r < round; r++) {
			...
			HeapSort::Sort(sort, sortArrayLength);
